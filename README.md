...
> **Note**: Datafication.CsvConnector is currently in pre-release. NuGet package availability is pending signing certificate approval and will be available soon.
...
The Datafication.CsvConnector library license is under review and will be published here once approved.
